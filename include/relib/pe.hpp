...
public:
	 ...
	 */
	RELIB_EXPORT PE(_In_ char* sFileName);
	 ...
	 */
	RELIB_EXPORT PE(_In_ HANDLE hFile);
	 ...
	 */
	RELIB_EXPORT PE(_In_ PE* pOther);
	 ...
	 */
	RELIB_EXPORT uint64_t* GetTLSCallbacks();
	 ...
	 */
	RELIB_EXPORT bool ParseFile(_In_ HANDLE hFile);
	 ...
	 */
	RELIB_EXPORT void RebaseImage(_In_ uint64_t u64NewBase);
	 ...
	 * @retval false Failure.
	 */
	RELIB_EXPORT bool WriteRVA(_In_ DWORD dwRVA, _In_ void* pData, _In_ size_t szData);
	 ...
	 * @retval false Failure.
	 */
	RELIB_EXPORT bool ReadRVA(_In_ DWORD dwRVA, _Out_ void* pData, _In_ size_t szData);
	 ...
	 */
	RELIB_EXPORT virtual void DeleteSection(_In_ WORD wIndex);
	 ...
	 */
	RELIB_EXPORT WORD FindSectionByRaw(_In_ DWORD dwRaw);

	/*!
	 * @brief Remove the DOS stub.
	 */
	RELIB_EXPORT void StripDosStub();
	 ...
	 */
	RELIB_EXPORT IAT_ENTRY* GetIAT();

	/*!
	 * @brief Removes the PE overlay.
	 */
	RELIB_EXPORT void DiscardOverlay();
	 ...
	 */
	RELIB_EXPORT DWORD GetOverlayOffset();
	 ...
	 * @retval _UI16_MAX Not found.
	 */
	RELIB_EXPORT WORD FindSectionByRVA(_In_ DWORD dwRVA);
	 ...
	 */
	RELIB_EXPORT DWORD RVAToRaw(_In_ DWORD dwRVA);
	 ...
	 * @retval NULL Unable to translate.
	 */
	RELIB_EXPORT DWORD RawToRVA(_In_ DWORD dwRaw);
	 ...
	 * @retval false Failure.
	 */
	RELIB_EXPORT bool ProduceBinary(_In_ HANDLE hFile);
	 ...
	 * @retval false Failure.
	 */
	RELIB_EXPORT bool ProduceBinary(_In_ char* sName);
	 ...
	 */
	RELIB_EXPORT Vector<DWORD> GetExportedSymbolRVAs();
	 ...
	 */
	RELIB_EXPORT Vector<char*> GetExportedSymbolNames();
	 ...
	 */
	RELIB_EXPORT Vector<IMAGE_IMPORT_DESCRIPTOR> GetImportedDLLs();
	 ...
	 */
	RELIB_EXPORT char* ReadRVAString(_In_ DWORD dwRVA);
